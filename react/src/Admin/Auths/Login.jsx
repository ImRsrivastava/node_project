...
const Login = () => {
    ...
    const {setAuthUser, manageToken} = useAdminStateContext();
    ...
    const handleSubmit = () => {
        ...
        axiosAdminInstance.post('/login', {email:formData.email, password:formData.password, role:1})
        .then((response) => {
    ...
    return (
        <>
            ...
            {/* <div className="card mb-3"> This Admin Login page </div> */}
        </>
    )
}
